...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    {
      quote:
        "CodeProbe has completely transformed our hiring process. We're able to evaluate candidates' real-world skills in a way that traditional interviews simply couldn't match.",
      name: "Sarah Johnson",
    ...
    {
      quote:
        "The quality of engineers we've hired since implementing CodeProbe has increased dramatically. The platform lets us see exactly how candidates think and solve problems.",
      name: "Michael Chen",
      ...
      <div className="container max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto reveal animation-delay-200">
            Companies across the tech industry are transforming their hiring process with CodeProbe
          </p>
        </div>
